...
| Doc | URL |
|-----|-----|
| The Atlas Diagnostic Snapshot service | <https://<REDACTED-WIKI-CORP-MONGODB-COM>/spaces/cs/pages/260914369/The+Atlas+Diagnostic+Snapshot+service> |
| TSE Toolbelt | <https://<REDACTED-WIKI-CORP-MONGODB-COM>/spaces/cs/pages/87470010/TSE+Toolbelt> |
| Cloud Support Home | <https://<REDACTED-WIKI-CORP-MONGODB-COM>/spaces/cs/pages/91000982/Cloud+Support+Home> |
| Atlas Diagnostic Checklist and Template | <https://<REDACTED-WIKI-CORP-MONGODB-COM>/spaces/cs/pages/96667896/Atlas+Diagnostic+Checklist+and+Template> |
| MMS API Landscape | <https://<REDACTED-WIKI-CORP-MONGODB-COM>/spaces/MMS/pages/346202846/MMS+API+Landscape> |
...
| [10gen/<REDACTED-TS-SEARCH-EXPLAIN-HELPER>](https://github.com/10gen/<REDACTED-TS-SEARCH-EXPLAIN-HELPER>) | Search explain-plan visualization and AI analysis |
| [10gen/<REDACTED-MONGOLYSER>](https://github.com/10gen/<REDACTED-MONGOLYSER>) | Electron app for MongoDB performance and log analysis |
...
| [10gen/<REDACTED-DEVPROD-MCP-ROUTER>](https://github.com/10gen/<REDACTED-DEVPROD-MCP-ROUTER>) | MCP gateway for internal debugging backends |
| [10gen/<REDACTED-TS-FTDC-REQUESTOR>](https://github.com/10gen/<REDACTED-TS-FTDC-REQUESTOR>) | FTDC retrieval service |
...
3. Use specialized analyzers (`alexandria`, `t2`, SearchPlanIQ, `mtools`, <REDACTED-MONGOLYSER>) when first-pass insufficient
...
### SearchPlanIQ (<REDACTED-TS-SEARCH-EXPLAIN-HELPER>)
...
3. Use <REDACTED-MONGOLYSER> when broader multi-signal interactive workflow helpful.
...
- <REDACTED-MONGOLYSER> feature list and Electron startup flow
...
- `<REDACTED-TS-FTDC-REQUESTOR>` runtime usage details
