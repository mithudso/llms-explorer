---
title: "Local LLM model load path over a Thunderbolt eGPU"
description: "What happens between a model file on NVMe and weights resident in VRAM when the host link is slow: the stages and which one bounds cold and warm loads, llama.cpp load modes, Ollama and LM Studio keep-"
---
