...
- [redacted] usage and adjacent internal support tools
...
- Cloning/installing/running [redacted] repos — use `misc-catch-all` (references/[redacted].md)
...
| Doc | URL |
|-----|-----|
| The Atlas Diagnostic Snapshot service | <https://[redacted]/spaces/cs/pages/260914369/The+Atlas+Diagnostic+Snapshot+service> |
| TSE Toolbelt | <https://[redacted]/spaces/cs/pages/87470010/TSE+Toolbelt> |
| Cloud Support Home | <https://[redacted]/spaces/cs/pages/91000982/Cloud+Support+Home> |
| Atlas Diagnostic Checklist and Template | <https://[redacted]/spaces/cs/pages/96667896/Atlas+Diagnostic+Checklist+and+Template> |
| MMS API Landscape | <https://[redacted]/spaces/MMS/pages/346202846/MMS+API+Landscape> |

### Tool repositories

| Repo | Purpose |
|------|---------|
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | Atlas diagnostic snapshot service and CLI |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | FTDC analysis and rules engine |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | Search explain-plan visualization and AI analysis |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | Electron app for MongoDB performance and log analysis |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | Support tooling installed on Atlas nodes |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | Umbrella repo for internal TS tooling |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | MCP gateway for internal debugging backends |
| [[redacted]/[redacted]](https://github.com/[redacted]/[redacted]) | FTDC retrieval service |
...
1. Start with fastest curated view (`[redacted]`, Atlas UI summaries, Performance Advisor, alerts, metrics)
2. Gather focused artifacts (logs, FTDC, explain plans, profiler samples)
3. Use specialized analyzers (`[redacted]`, `t2`, SearchPlanIQ, `mtools`, [redacted]) when first-pass insufficient
...
- `[redacted]` is **single-pane-of-glass first stop** for Atlas project and cluster triage.
...
|---------|----------|----------------|-----------------|
| [redacted] web | Fast Atlas case triage | case/project/cluster context | Project snapshot, cluster snapshot, quick diagnostics, links to logs/FTDC/UI |
| [redacted] CLI | Atlas API-backed project/cluster inspection from terminal | case/profile, project/org/cluster identifiers | Text/JSON/markdown output |
...
**Access/install/run:**
- Web: <https://[redacted].cloud-ops.prod.[redacted]/> or `go/tsdiag`
- CLI: `[redacted]` (requires Atlas CLI profiles and employee Okta auth; VPN / Cloudflare WARP for CLI auth)
- Dev: Go `1.24.2+` and `GOPRIVATE=github.com/[redacted]/*`
...
- CLI: `[redacted] diagnostic.data/*` or `[redacted] -query '...' diagnostic.data/*`
...
**What it checks:** Trending and timing relationships in FTDC data; follow-up after [redacted] or checklist-based suspicion
...
1. Start in `[redacted]` for project and cluster snapshot.
...
- `[redacted]` purpose, access paths, and CLI/API orientation
...
- [redacted] feature list and Electron startup flow
...
- `[redacted]` script-by-script behavior
- `[redacted]` runtime usage details
...
All MongoDB knowledge split across **four hubs** (plus `misc-catch-all` for KB-article lookups via references/mongodb-kb.md and repo install/run via references/[redacted].md). If task's deep material **not** in this hub's Sub-skill routing table, it is reference file under sibling hub — **activate that hub or Read its `references/<name>.md` directly**.
