...
@pytest.mark.parametrize("text", [
    "HUB_OLLAMA_URLS=http://192.0.2.75:11434=4",       # privacy-ok
...
def test_scrub_keeps_the_last_octet_and_lands_in_rfc5737():
    src = ("pool http://192.0.2.75:11434=4,http://192.0.2.113:11434=3 · tailnet 198.51.100.117 "  # privacy-ok
           "· gateway 192.0.2.0/24 · ssh someone.else@192.0.2.113 · user@10.1.2.3")  # privacy-ok
