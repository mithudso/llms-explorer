...
description: >-
  ...
  docs → document-critique; SQL → deep-query-optimizer; crawling a site → web-text-mirror.
...
`prompt-deep-optimizer`. Prose docs → document-critique. Moved page → `web-text-mirror`.
