...
Usage:
  ...
  <customer-folder>  folder name under the engagements root, e.g. "[redacted]"
  --expect           other-customer names that are legitimately present because a
                     declared multi-account source was used, e.g. --expect "[redacted],[redacted],[redacted]"
...
DEFAULT_ROOT = ("/Users/mitch.hudson/Library/CloudStorage/"
                "GoogleDrive-[redacted]/Shared drives/"
                "[redacted] - [redacted]/Engagements")
