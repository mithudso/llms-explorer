...
Usage:
  ...
  <customer-folder>  folder name under the engagements root, e.g. "<REDACTED-GS>"
  --expect           other-customer names that are legitimately present because a
                     declared multi-account source was used, e.g. --expect "<REDACTED-JPMORGAN-CHASE>,<REDACTED-OKTA>,<REDACTED-CUST-I>"
...
DEFAULT_ROOT = ("/Users/mitch.hudson/Library/CloudStorage/"
                "GoogleDrive-<REDACTED-MITCH-HUDSON-MONGODB-COM>/Shared drives/"
                "<REDACTED-TS-PREMIUM-SERVICES> - <REDACTED-TAM-NTSE>/Engagements")
