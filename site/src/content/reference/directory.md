...
the 989 we have fetched, from a catalog of 1230 known files — with a conformance grade beside
...
**Not fetched.** The catalog holds 1230 keys; 989 of them have a file on disk. Of the rest, 4
downloaded on another machine but are not in this repo's mirror, 162 failed to download, and 75
...
989 do. The other 826 are still markdown documentation, and the catalog deliberately keeps them
