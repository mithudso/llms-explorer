---
title: "PCIe power management and error handling for a Thunderbolt eGPU: ASPM, D3cold, runtime PM, AER and DPC"
description: "Which PCIe power-management and error-handling knobs actually matter for a Thunderbolt-tunnelled GPU on Linux — ASPM and pcie_aspm=off versus pcie_aspm.policy, port runtime PM and D3cold, NVIDIA's run"
---
...
- **Coming default change:** RFC v2 (2026-05-11, by the RFC author): BIOS ≥2025 → `powersupersave` if FADT allows; honoured exceptions: user policy or `pcie_aspm` param. If merged, hosts like this NUC (2025+ BIOS) will start enabling L1/L1.x on links Linux configures — consider pinning `pcie_aspm.policy=performance` or keeping `pcie_aspm=off` (which leaves the setting untouched) to prevent it. [SOURCED https://lkml.iu.edu/2605.1/06202.html]
...
- ASPM doc-fix patch (pcie_aspm=off semantics), PCI maintainer, Apr 2024: https://lkml.iu.edu/hypermail/linux/kernel/2404.3/06648.html
...
- RFC v2 "pcie/aspm: Enable all hardware power-saving states by default", RFC author, 2026-05-11: https://lkml.iu.edu/2605.1/06202.html
- "PCI/ASPM: Enable L0s/L1 for removable devices" thread (Windows vs Linux eGPU lspci), patch author, May 2026: https://ratatoskr.run/linux-pci/2026/05/3543749/t
...
- "PCI: Whitelist Thunderbolt ports for runtime D3" (runtime-PM patch author): https://patchwork.kernel.org/project/linux-pci/patch/10206fe7f3967aa73ade5b24dc729de0e94c3b7f.1529173804.git.lukas@wunner.de/
