...
# 192.0.2.1 IS this machine (same box as localhost) -- listed only once, as
# localhost, so one host isn't double-counted under two URLs.
DEFAULT_URLS = "http://192.0.2.75:11434=4,http://192.0.2.113:11434=3,http://localhost:11434=1"
