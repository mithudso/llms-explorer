...
description: "This local skill is generated from docs/mongodb-expert-context.md in [redacted]/mdb-tam."
---

# MongoDB Expert

This local skill is generated from `docs/mongodb-expert-context.md` in `[redacted]/mdb-tam`.
...
| Install / run MongoDB locally from a repo | `[redacted]` |
...
| `atlas-diagnostics-expert` | Live **diagnostics & performance**: [redacted], FTDC, performance-troubleshooting symptom triage, benchmarking, monitoring/observability, capacity planning | `references/mongodb-performance-troubleshooting.md` |
