---
description: LLMs Deep Optimizer — multi-pass audit-and-fix of any llms.txt / llms-full.txt / llms-small.txt / llms-facts.txt / family index (structure, links, descriptions, size ladder, grammar, facts truth, provenance, serving, keyword+vector+agent probes) to convergence; or build a topical llms file from a fact pool
