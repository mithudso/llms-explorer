...
| `api/explorer_api/routes/skills.py` | Anthropic Claude API | HTTPS REST (`anthropic` SDK) | `anthropic.APIError` / `gw.GatewayRefusal` | Fail on provider error; ledger records all attempts (component 16 §1) |
