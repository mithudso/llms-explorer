...
**Repo:** github.com/mithudso/llms-explorer (this repo becomes the site) · **Runtime today:** `~/.global-ai-hub` (M5 + 192.0.2.75 RTX 5080 + 192.0.2.113)
...
`BoxPool` placement rules and quiet hours apply — 192.0.2.113 is off-limits Mon–Fri 09–17),
