...
| Troubleshooting / diagnostic reasoning | `atlas-diagnostics-expert`, `software-engineering-patterns`, `teaching-troubleshooting-diagnostic-reasoning`, `[redacted]` | Chooses the diagnostic surface and gathers evidence |
